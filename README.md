...
- [Building base lazylinux from scratch](#building-base-system)
...
### Building lazylinux base-system from scratch
...
Once the build has finished, you can specify the path to the local repository to `lazylinux-mklive`, i.e:
